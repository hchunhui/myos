#ifndef _BEETLEDEMON_H_FILE_INCLUDED_

#define _BEETLEDEMON_H_FILE_INCLUDED_

#include "Object.h"

class CBeetleDemon:public CObject
{
public:
	CBeetleDemon(CGame * Game,int x, int y);
...
private:
	...
	bool m_MarioBump;//变成甲虫壳时，是否只要被玛莉碰到就运动
};
